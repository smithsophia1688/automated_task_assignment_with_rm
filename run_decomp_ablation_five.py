...
for xx in trials:
    ...
    bd = root.traverse_ablation(configs, condition = condition)
    ...
    for a in range(num_agents):
        aap = aap_dict[a]
        rm_file_name = experiment_time + '_' + condition +'_' + str(a) + '.txt'
    ...
    tester_file_name = experiment_time + f'_{condition}.pkl'
