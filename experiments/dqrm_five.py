    ...
    for t in range(num_steps): # 1000 max
        ...
        if testing_params.test and tester.get_current_step() % testing_params.test_freq == 0:
            ...
            if step not in tester.results['trajectories']:
                tester.results['trajectories'][step] = [] # step is like what episode we are on. We restart the episode after every 1000
...
def run_multi_agent_experiment(tester,
    ...
    #s_history_0, l_history_0 = tester.process_results()
